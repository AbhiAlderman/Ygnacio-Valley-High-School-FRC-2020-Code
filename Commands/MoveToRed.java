...
public class MoveToRed extends CommandBase {
  private final ControlPanelSubsystem m_controlpanelsubsystem;
  /**
   * Creates a new MoveToRed.
   */
  public MoveToRed(ControlPanelSubsystem controlpanelsubsystem) {
  ...
  @Override
  public void execute() {
    m_controlpanelsubsystem.spinToRed();
