...
public class PanelSlow extends CommandBase {
  private ControlPanelSubsystem m_controlPanelSubsystem;
  /**
   * Creates a new PanelSlow.
   */
  public PanelSlow(ControlPanelSubsystem controlPanelSubsystem){
  ...
  @Override
  public void execute() {
    m_controlPanelSubsystem.spinSlow();
