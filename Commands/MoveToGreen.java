...
public class MoveToGreen extends CommandBase {
  private ControlPanelSubsystem m_controlpanelsubsystem;
  /**
   * Creates a new MoveToGreen.
   */
  public MoveToGreen(ControlPanelSubsystem controlpanelsubsystem) {
  ...
  @Override
  public void execute() {
    m_controlpanelsubsystem.spinToGreen();
